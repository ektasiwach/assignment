...
newCoe = list1Node->coe + list2Node->coe;
 newExp = list1Node->exp;
list1Node = list1Node->link;
list2Node = list2Node->link;
}

 else if (list1Node->exp > list2Node->exp) {
newCoe = list1Node->coe;
 newExp = list1Node->exp;
 list1Node = list1Node->link;
} 

else {
newCoe = list2Node->coe;
 newExp = list2Node->exp;
  list2Node = list2Node->link;
}
...
while (list2Node != NULL) {
int newCoe = list1Node->coe * list2Node->coe;
 int newExp = list1Node->exp + list2Node->exp;
...
list3 = add(&list1, &list2); printf("Sum: ");
 display(list3);
list4 = multiply(&list1, &list2);
 printf("Product: "); display(list4);
return 0;
